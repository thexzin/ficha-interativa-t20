;(function(){
  ...
  const vampiro="Material fornecido, p. 73–75";
  const blessing=(name,desc,cost="",action="")=>({
    ...ability(vampiro,name,["Vampiro"],desc,cost,action),
    subtype:"Bênção Vampírica"
  });
  const powers=[
    ability(vampiro,"Carisma +1, +1 em dois atributos (exceto Constituição), Constituição -1",["Vampiro"],"Modificadores de atributos de vampiro."),
    ability(vampiro,"Bênçãos Vampíricas",["Vampiro"],`Escolha uma bênção vampírica. Uma vez por patamar, você pode escolher outra bênção no lugar de um poder de classe. Você deve continuar cumprindo os pré-requisitos das bênçãos escolhidas.`),
    ability(vampiro,"Resquícios da Outra Vida",["Vampiro"],`Você se torna treinado em uma perícia que não seja de sua classe ou recebe um poder geral a sua escolha. Como alternativa, se era de outra raça humanoide ou monstro que não humano, pode receber uma habilidade dessa raça, aprovada pelo mestre. Se a raça original tinha tamanho diferente de Médio, você também mantém essa categoria de tamanho.`),
    ability(vampiro,"Natureza Não Viva",["Vampiro"],`Você é uma criatura do tipo morto-vivo. Recebe visão no escuro e imunidade a efeitos de cansaço, metabólicos, de trevas e de veneno. Não precisa respirar, alimentar-se ou dormir. Efeitos mágicos de cura de luz causam dano em você, dano de trevas recupera seus PV e você não se beneficia de itens da categoria alimentação.`),
    ability(vampiro,"Perda da Humanidade",["Vampiro"],`Conforme seus poderes vampíricos crescem, sua humanidade sucumbe. Você possui Chamado das Trevas, Sede de Sangue e Sensibilidade ao Sol; essas fraquezas se tornam mais severas conforme você recebe novas bênçãos vampíricas.`),
    ability(vampiro,"Chamado das Trevas",["Vampiro"],`Você precisa repousar por oito horas dentro da terra, no subterrâneo, em uma cova ou totalmente coberto de terra. Se fizer isso, recupera PV e PM por descanso em condições normais. Caso contrário, sofre –1 em perícias por bênção vampírica que possuir. A penalidade desaparece após repousar na terra.`),
    ability(vampiro,"Sede de Sangue",["Vampiro"],`Você precisa consumir pelo menos uma dose de sangue por semana. Se não fizer isso, sofre os efeitos de fome. Para cada bênção vampírica além da primeira, o intervalo entre refeições de sangue diminui em um dia, até o mínimo de uma dose por dia.`),
    ability(vampiro,"Sensibilidade ao Sol",["Vampiro"],`Quando exposto à luz solar direta, você fica ofuscado e, a cada rodada, perde 1d6 PV por bênção vampírica que possuir.`),
    ability(vampiro,"Dieta de Sangue",["Vampiro"],`Você precisa consumir sangue de uma criatura viva, preferencialmente inteligente. Uma dose equivale a 1 litro de sangue ou a drenar 2d6 PV de um ser vivo. A origem do sangue altera seus efeitos por um dia. Animal: você fica fraco até ingerir sangue de outro tipo. Espírito: seu total de PM aumenta em +2 por patamar e você recebe +2 na CD de suas habilidades mágicas. Humanoide: não fornece penalidades nem benefícios adicionais. Monstro: você recebe +1 em Força e sofre –2 em testes de perícias baseadas em Carisma, exceto Intimidação. Um humanoide ou monstro morto por drenagem suficiente se ergue como vampiro na noite seguinte e deve vencer um teste oposto de Vontade para não ficar sob controle de quem o criou.`),

    blessing("Cura Acelerada",`No início de um de seus turnos, você pode gastar 1 PM para recuperar 5 PV. A partir do 5º nível, pode escolher esta bênção uma segunda vez para aumentar a cura para 10 PV por PM gasto.`,"1 PM","Início do turno"),
    blessing("Dominação Vampírica",`Você pode gastar uma ação completa e 3 PM para sussurrar palavras de controle para um humanoide em alcance curto. O alvo fica confuso, enfeitiçado ou fascinado até o fim da cena, ou perde suas memórias da última hora, à sua escolha; Vontade contra CD Car evita. Uma criatura só pode ser alvo desta habilidade uma vez por cena. Pré-requisito: Presença Majestosa.`,"3 PM","Completa"),
    blessing("Drenar Sangue",`Você pode gastar uma ação padrão para drenar sangue de uma criatura viva que esteja agarrando. Você causa 2d6 pontos de dano de perfuração por patamar e recupera a mesma quantidade de PV. Drenar sangue desta forma conta como se alimentar.`,"","Padrão"),
    blessing("Forma de Lobo",`Você pode gastar uma ação padrão e 3 PM para se transformar em um lobo. Isso conta como o efeito básico da Forma Selvagem Feroz, exceto que você se torna Médio, recebe +3m em seu deslocamento e, no lugar da arma natural, recebe uma arma natural de mordida que causa 1d6 pontos de dano. Se já tiver uma mordida, o dano dela aumenta em um passo.`,"3 PM","Padrão"),
    blessing("Forma de Morcego",`Você pode gastar uma ação padrão e 3 PM para se transformar em morcego. Você se torna Minúsculo, recebe +5 em Furtividade, –5 em testes de manobra e deslocamento de voo 12m. Seu equipamento é absorvido e suas outras estatísticas não são alteradas. A transformação dura quanto tempo desejar, mas termina se você fizer um ataque, lançar uma magia ou sofrer dano.`,"3 PM","Padrão"),
    blessing("Garras",`Suas mãos são duas armas naturais de garras (dano 1d6, crítico x2, corte). Uma vez por rodada, quando usa a ação agredir para atacar com uma arma, pode gastar 1 PM para fazer um ataque corpo a corpo extra com uma garra livre que ainda não tenha sido usada no turno. Também pode usar as garras com habilidades que exijam uma arma secundária.`,"1 PM"),
    blessing("Manto das Sombras",`Você pode lançar Invisibilidade, mas apenas em você. Caso aprenda novamente essa magia, seu custo diminui em –1 PM.`),
    blessing("Passo Vampírico",`Você recebe +3m de deslocamento e deslocamento de escalada igual ao seu deslocamento padrão.`),
    blessing("Presença Majestosa",`Você recebe a habilidade Presença Aristocrática. Se já possuir essa habilidade, seu custo diminui em –1 PM e a CD para resistir a ela aumenta em +2.`),
    blessing("Resiliência Sombria",`Você recebe redução de dano 5/luz. Pré-requisitos: Presença Majestosa e 5º nível.`),
